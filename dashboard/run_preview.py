    ...
    if path == "/api/ranked/season":
        return web.json_response({
            "season": {
                ...
                "weekly_rule_desc": "노말 타입 포켓몬 사용 불가",
                "starts_at": "2026-03-09 00:00:00+09:00",
                "ends_at": "2026-03-22 23:59:59+09:00",
            },
            "ranking": [
                {"user_id": 1, "display_name": "트레이너A", "title_emoji": "",
                 "rp": 1340, "tier": "challenger", "tier_display": "⚔️챌린저",
                 "division_display": "⚔️ 챌린저 — 1340 RP",
                 "placement_done": True, "placement_games": 5, "mmr": 1820,
                 "ranked_wins": 35, "ranked_losses": 8, "best_ranked_streak": 9,
                 "peak_rp": 1340, "peak_tier": "challenger"},
                {"user_id": 2, "display_name": "트레이너B", "title_emoji": "",
                 "rp": 1120, "tier": "master", "tier_display": "👑마스터",
                 "division_display": "👑 마스터 — 1120 RP",
                 "placement_done": True, "placement_games": 5, "mmr": 1680,
                 "ranked_wins": 28, "ranked_losses": 12, "best_ranked_streak": 6,
                 "peak_rp": 1180, "peak_tier": "master"},
                {"user_id": 3, "display_name": "트레이너C", "title_emoji": "",
                 "rp": 920, "tier": "diamond", "tier_display": "💠다이아",
                 "division_display": "💠 다이아 I — 20 RP", "division_rp": 20,
                 "placement_done": True, "placement_games": 5, "mmr": 1520,
                 "ranked_wins": 20, "ranked_losses": 10, "best_ranked_streak": 5,
                 "peak_rp": 920, "peak_tier": "diamond"},
                {"user_id": 4, "display_name": "트레이너D", "title_emoji": "",
                 "rp": 850, "tier": "diamond", "tier_display": "💠다이아",
                 "division_display": "💠 다이아 II — 50 RP", "division_rp": 50,
                 "placement_done": True, "placement_games": 5, "mmr": 1450,
                 "ranked_wins": 18, "ranked_losses": 9, "best_ranked_streak": 4,
                 "peak_rp": 870, "peak_tier": "diamond"},
                {"user_id": 5, "display_name": "트레이너E", "title_emoji": "",
                 "rp": 645, "tier": "platinum", "tier_display": "💎플래티넘",
                 "division_display": "💎 플래티넘 II — 45 RP", "division_rp": 45,
                 "placement_done": True, "placement_games": 5, "mmr": 1380,
                 "ranked_wins": 15, "ranked_losses": 8, "best_ranked_streak": 3,
                 "peak_rp": 680, "peak_tier": "platinum"},
                {"user_id": 6, "display_name": "트레이너F", "title_emoji": "",
                 "rp": 478, "tier": "gold", "tier_display": "🏅골드",
                 "division_display": "🏅 골드 II — 78 RP", "division_rp": 78,
                 "placement_done": True, "placement_games": 5, "mmr": 1250,
                 "ranked_wins": 12, "ranked_losses": 7, "best_ranked_streak": 4,
                 "peak_rp": 520, "peak_tier": "gold"},
                {"user_id": 7, "display_name": "트레이너G", "title_emoji": "",
                 "rp": 320, "tier": "silver", "tier_display": "🥈실버",
                 "division_display": "🥈 실버 I — 20 RP", "division_rp": 20,
                 "placement_done": True, "placement_games": 5, "mmr": 1100,
                 "ranked_wins": 8, "ranked_losses": 6, "best_ranked_streak": 3,
                 "peak_rp": 350, "peak_tier": "silver"},
                {"user_id": 8, "display_name": "트레이너H", "title_emoji": "",
                 "rp": 230, "tier": "silver", "tier_display": "🥈실버",
                 "division_display": "🥈 실버 II — 30 RP", "division_rp": 30,
                 "placement_done": True, "placement_games": 5, "mmr": 1050,
                 "ranked_wins": 6, "ranked_losses": 5, "best_ranked_streak": 2,
                 "peak_rp": 260, "peak_tier": "silver"},
                {"user_id": 9, "display_name": "트레이너I", "title_emoji": "",
                 "rp": 85, "tier": "bronze", "tier_display": "🥉브론즈",
                 "division_display": "🥉 브론즈 II — 85 RP", "division_rp": 85,
                 "placement_done": True, "placement_games": 5, "mmr": 950,
                 "ranked_wins": 4, "ranked_losses": 5, "best_ranked_streak": 2,
                 "peak_rp": 120, "peak_tier": "bronze"},
                {"user_id": 10, "display_name": "뉴비트레이너", "title_emoji": "",
                 "rp": 0, "tier": "unranked", "tier_display": "❓언랭",
                 "division_display": "🎯 배치중 (3/5)",
                 "placement_done": False, "placement_games": 3, "mmr": 1200,
                 "ranked_wins": 2, "ranked_losses": 1, "best_ranked_streak": 1,
                 "peak_rp": 0, "peak_tier": "unranked"},
            ],
            "tier_distribution": {
                "challenger": 2, "master": 3, "diamond": 5,
                "platinum": 8, "gold": 12, "silver": 15,
                "bronze": 10, "placement": 4, "unranked": 6
            },
            "total_players": 65,
        })
    ...
    if path == "/api/battle/tiers":
        return web.json_response([
            {"id": 150, "name": "뮤츠", "emoji": "🔮", "rarity": "ultra_legendary", "evo_stage": 3,
             ...
             "power": 95.2, "skill_name": "사이코브레이크",
             "skill_power": 2.0, "hp": 318, "atk": 110, "def_": 90,
             "spa": 154, "spdef": 90, "spd": 130,
             "skill_effects": [{"name": "사이코브레이크", "power": 2.0, "type": "normal"}]},
            {"id": 242, "name": "해피너스", "emoji": "🩷", "rarity": "epic", "evo_stage": 3,
             ...
             "skill_effects": [{"name": "알폭탄", "power": 1.3, "type": "normal"}]},
            {"id": 250, "name": "칠색조", "emoji": "🔥", "rarity": "ultra_legendary", "evo_stage": 3,
             "type1": "fire", "type2": "flying", "stat_ko": "공격",
             "power": 85.4, "skill_name": "성스러운불꽃/에어슬래시",
             "skill_power": 2.0, "hp": 306, "atk": 120, "def_": 88,
             "spa": 104, "spdef": 138, "spd": 88,
             "skill_effects": [{"name": "성스러운불꽃", "power": 2.0, "type": "normal"}, {"name": "에어슬래시", "power": 2.0, "type": "normal"}]},
            {"id": 249, "name": "루기아", "emoji": "🌊", "rarity": "ultra_legendary", "evo_stage": 3,
             ...
             "skill_effects": [{"name": "에어로블라스트", "power": 1.7, "type": "normal"}]},
            {"id": 248, "name": "마기라스", "emoji": "🪨", "rarity": "epic", "evo_stage": 3,
             "type1": "rock", "type2": "dark", "stat_ko": "공격",
             "power": 67.5, "skill_name": "스톤에지/깨물어부수기",
             "skill_power": 1.5, "hp": 291, "atk": 123, "def_": 104,
             "spa": 93, "spdef": 97, "spd": 67,
             "skill_effects": [{"name": "스톤에지", "power": 1.5, "type": "normal"}, {"name": "깨물어부수기", "power": 1.5, "type": "normal"}]},
            {"id": 149, "name": "망나뇽", "emoji": "🐉", "rarity": "epic", "evo_stage": 3,
             "type1": "dragon", "type2": "flying", "stat_ko": "공격",
             "power": 61.9, "skill_name": "역린/폭풍",
             "skill_power": 1.5, "hp": 270, "atk": 123, "def_": 93,
             "spa": 97, "spdef": 97, "spd": 81,
             "skill_effects": [{"name": "역린", "power": 1.5, "type": "recoil", "damage_bonus": 2.0, "pct": 0.25}, {"name": "폭풍", "power": 1.5, "type": "normal"}]},
            {"id": 143, "name": "잠만보", "emoji": "😴", "rarity": "epic", "evo_stage": 3,
             "type1": "normal", "type2": None, "stat_ko": "방어",
             "power": 55.0, "skill_name": "잠자기",
             "skill_power": 1.5, "hp": 490, "atk": 95, "def_": 70,
             "spa": 62, "spdef": 95, "spd": 35,
             "skill_effects": [{"name": "잠자기", "power": 1.5, "type": "rest", "heal_pct": 0.35}]},
            ...
            {"id": 131, "name": "라프라스", "emoji": "🧊", "rarity": "rare", "evo_stage": 3,
             ...
             "skill_effects": [{"name": "냉동빔", "power": 1.5, "type": "normal"}]},
            {"id": 25, "name": "피카츄", "emoji": "⚡", "rarity": "rare", "evo_stage": 2,
             ...
             "skill_effects": [{"name": "10만볼트", "power": 1.4, "type": "normal"}]},
            {"id": 20, "name": "레트라", "emoji": "🐀", "rarity": "common", "evo_stage": 3,
             ...
             "skill_effects": [{"name": "필살앞니", "power": 1.4, "type": "normal"}]},
            {"id": 129, "name": "잉어킹", "emoji": "🐟", "rarity": "common", "evo_stage": 3,
             "type1": "water", "type2": None, "stat_ko": "공격",
             "power": 5.1, "skill_name": "튀어오르기",
             "skill_power": 1.2, "hp": 205, "atk": 50, "def_": 55,
             "spa": 15, "spdef": 20, "spd": 80,
             "skill_effects": [{"name": "튀어오르기", "power": 1.2, "type": "splash"}]},
        ])
...
async def mock_my_summary(request):
    return web.json_response({
        ...
        "ranked":{
            "rp":378,"tier":"silver","division":1,"division_rp":78,
            "division_display":"🥈 실버 I — 78 RP",
            "ranked_wins":28,"ranked_losses":12,"ranked_streak":3,
            "best_ranked_streak":7,"peak_rp":420,"peak_tier":"gold",
            "peak_display":"🏅 골드 II — 20 RP",
            "placement_done":True,"placement_games":5,
            "mmr":1350,"peak_mmr":1420,"mmr_games":42
        }
    })
