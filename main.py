...
from handlers.admin import (
    spawn_rate_handler, force_spawn_handler,
...
def main():
    ...
    app.add_handler(MessageHandler(dm & filters.Regex(r"^밥\s*\d*$"), feed_handler))
    app.add_handler(MessageHandler(dm & filters.Regex(r"^놀기\s*\d*$"), play_handler))
    app.add_handler(MessageHandler(dm & filters.Regex(r"^진화\s*\d*$"), evolve_handler))
