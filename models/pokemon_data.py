...
ALL_POKEMON = [
    # --- Bulbasaur line ---
    (1, "이상해씨", "Bulbasaur", "🌱", "common", 1.00, None, 2, "friendship"),
    (2, "이상해풀", "Ivysaur", "🌿", "rare", 0.80, 1, 3, "friendship"),
    (3, "이상해꽃", "Venusaur", "🌺", "epic", 0.05, 2, None, "none"),

    # --- Charmander line ---
    (4, "파이리", "Charmander", "🔥", "common", 1.00, None, 5, "friendship"),
    (5, "리자드", "Charmeleon", "🔥", "rare", 0.80, 4, 6, "friendship"),
    (6, "리자몽", "Charizard", "🔥", "epic", 0.05, 5, None, "none"),

    # --- Squirtle line ---
    (7, "꼬부기", "Squirtle", "💧", "common", 1.00, None, 8, "friendship"),
    (8, "어니부기", "Wartortle", "💧", "rare", 0.80, 7, 9, "friendship"),
    ...
    (47, "파라섹트", "Parasect", "🍄", "rare", 0.80, 46, None, "none"),

    # --- Venonat line ---
    (48, "콘팡", "Venonat", "🐛", "common", 0.75, None, 49, "friendship"),
    (49, "도나리", "Venomoth", "🦋", "rare", 0.80, 48, None, "none"),

    # --- Diglett line ---
    (50, "디그다", "Diglett", "🕳️", "common", 0.75, None, 51, "friendship"),
    (51, "닥트리오", "Dugtrio", "🕳️", "rare", 0.80, 50, None, "none"),

    # --- Meowth line ---
    (52, "나옹", "Meowth", "🐱", "common", 0.75, None, 53, "friendship"),
    (53, "페르시온", "Persian", "🐱", "rare", 0.80, 52, None, "none"),

    # --- Psyduck line ---
    (54, "고라파덕", "Psyduck", "🦆", "common", 0.75, None, 55, "friendship"),
    (55, "골덕", "Golduck", "🦆", "epic", 0.30, 54, None, "none"),

    # --- Mankey line ---
    (56, "망키", "Mankey", "🐵", "common", 0.75, None, 57, "friendship"),
    (57, "성원숭", "Primeape", "🐵", "rare", 0.80, 56, None, "none"),

    # --- Growlithe line ---
    (58, "가디", "Growlithe", "🐕", "common", 1.00, None, 59, "friendship"),
    (59, "윈디", "Arcanine", "🐕", "epic", 0.30, 58, None, "none"),

    # --- Poliwag line ---
    (60, "발챙이", "Poliwag", "💧", "common", 0.75, None, 61, "friendship"),
    (61, "슈륙챙이", "Poliwhirl", "💧", "common", 0.45, 60, 62, "friendship"),
    (62, "강챙이", "Poliwrath", "💧", "epic", 0.30, 61, None, "none"),

    # --- Abra line (Kadabra evolves by trade) ---
    (63, "캐이시", "Abra", "🔮", "common", 1.00, None, 64, "friendship"),
    ...
    (67, "근육몬", "Machoke", "💪", "rare", 0.80, 66, 68, "trade"),
    (68, "괴력몬", "Machamp", "💪", "epic", 0.30, 67, None, "none"),
    ...
    (73, "독파리", "Tentacruel", "🪼", "epic", 0.30, 72, None, "none"),
    ...
    (108, "내루미", "Lickitung", "👅", "common", 1.00, None, None, "none"),

    # --- Koffing line ---
    (109, "또가스", "Koffing", "💨", "common", 0.70, None, 110, "friendship"),
    (110, "또도가스", "Weezing", "💨", "rare", 0.80, 109, None, "none"),
    ...
    # --- Pinsir (no evolution) ---
    (127, "쁘사이저", "Pinsir", "🪲", "epic", 0.30, None, None, "none"),
    ...
    # --- Ditto (no evolution) ---
    (132, "메타몽", "Ditto", "🟣", "common", 1.00, None, None, "none"),

    # --- Eevee line (special: random evolution) ---
    (133, "이브이", "Eevee", "🦊", "common", 1.00, None, None, "friendship"),
    (134, "샤미드", "Vaporeon", "💧", "epic", 0.30, 133, None, "none"),
    (135, "쥬피썬더", "Jolteon", "⚡", "epic", 0.30, 133, None, "none"),
    (136, "부스터", "Flareon", "🔥", "epic", 0.30, 133, None, "none"),

    # --- Porygon (no evolution in Gen1) ---
    (137, "폴리곤", "Porygon", "🤖", "common", 1.00, None, None, "none"),

    # --- Omanyte line ---
    (138, "암나이트", "Omanyte", "🐚", "common", 1.00, None, 139, "friendship"),
    (139, "암스타", "Omastar", "🐚", "rare", 0.20, 138, None, "none"),

    # --- Kabuto line ---
    (140, "투구", "Kabuto", "🦀", "common", 1.00, None, 141, "friendship"),
    ...
    # --- Dratini line ---
    (147, "미뇽", "Dratini", "🐉", "common", 1.00, None, 148, "friendship"),
    ...
    (152, "치코리타", "Chikorita", "🌿", "common", 1.00, None, 153, "friendship"),
    (153, "베이리프", "Bayleef", "🌿", "rare", 0.80, 152, 154, "friendship"),
    (154, "메가니움", "Meganium", "🌺", "epic", 0.05, 153, None, "none"),

    # --- Cyndaquil line (Fire starter) ---
    (155, "브케인", "Cyndaquil", "🔥", "common", 1.00, None, 156, "friendship"),
    (156, "마그케인", "Quilava", "🔥", "rare", 0.80, 155, 157, "friendship"),
    (157, "블레이범", "Typhlosion", "🔥", "epic", 0.05, 156, None, "none"),

    # --- Totodile line (Water starter) ---
    (158, "리아코", "Totodile", "💧", "common", 1.00, None, 159, "friendship"),
    (159, "엘리게이", "Croconaw", "💧", "rare", 0.80, 158, 160, "friendship"),
    (160, "장크로다일", "Feraligatr", "💧", "epic", 0.05, 159, None, "none"),

    # --- Sentret line ---
    (161, "꼬리선", "Sentret", "🐿️", "common", 0.80, None, 162, "friendship"),
    (162, "다꼬리", "Furret", "🐿️", "rare", 0.80, 161, None, "none"),

    # --- Hoothoot line ---
    (163, "부우부", "Hoothoot", "🦉", "common", 0.80, None, 164, "friendship"),
    (164, "야부엉", "Noctowl", "🦉", "rare", 0.80, 163, None, "none"),
    ...
    (168, "아리아도스", "Ariados", "🕷️", "rare", 0.80, 167, None, "none"),

    # --- Crobat (evo from Golbat 42) ---
    (169, "크로뱃", "Crobat", "🦇", "epic", 0.30, 42, None, "none"),
    ...
    # --- Togepi line ---
    (175, "토게피", "Togepi", "⭐", "common", 1.00, None, 176, "friendship"),
    ...
    (180, "보송송", "Flaaffy", "⚡", "common", 1.00, 179, 181, "friendship"),
    ...
    # --- Murkrow ---
    (198, "니로우", "Murkrow", "🌙", "rare", 0.80, None, None, "none"),
    ...
    # --- Wobbuffet ---
    (202, "마자용", "Wobbuffet", "🔮", "rare", 0.80, None, None, "none"),
    ...
    # --- Dunsparce ---
    (206, "노고치", "Dunsparce", "🐍", "rare", 0.80, None, None, "none"),
    ...
    # --- Qwilfish ---
    (211, "침바루", "Qwilfish", "💧", "rare", 0.80, None, None, "none"),

    # --- Scizor (trade evo from Scyther 123) ---
    (212, "핫삼", "Scizor", "🐛", "epic", 0.10, 123, None, "none"),

    # --- Shuckle ---
    (213, "단단지", "Shuckle", "🐛", "epic", 0.30, None, None, "none"),
    ...
    (217, "링곰", "Ursaring", "🐻", "epic", 0.30, 216, None, "none"),
    ...
    # --- Corsola ---
    (222, "코산호", "Corsola", "💧", "rare", 0.80, None, None, "none"),
    ...
    # --- Mantine ---
    (226, "만타인", "Mantine", "💧", "rare", 0.80, None, None, "none"),
    ...
    (232, "코리갑", "Donphan", "🐘", "epic", 0.30, 231, None, "none"),
    ...
    # --- Smeargle ---
    (235, "루브도", "Smeargle", "🎨", "common", 1.00, None, None, "none"),
    ...
    (246, "애버라스", "Larvitar", "🪨", "common", 1.00, None, 247, "friendship"),
