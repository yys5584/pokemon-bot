...
ALL_POKEMON = [
    ...
    (82, "레어코일", "Magneton", "🧲", "rare", 0.50, 81, None, "none"),
    ...
    (108, "내루미", "Lickitung", "👅", "common", 0.80, None, None, "none"),
    ...
    (125, "에레브", "Electabuzz", "⚡", "rare", 0.50, None, None, "none"),

    # --- Magmar (no evolution in Gen1) ---
    (126, "마그마", "Magmar", "🔥", "rare", 0.50, None, None, "none"),
    ...
    # --- Aipom ---
    (190, "에이팜", "Aipom", "🐒", "common", 0.80, None, None, "none"),
    ...
    # --- Yanma ---
    (193, "왕자리", "Yanma", "🪰", "common", 0.80, None, None, "none"),
    ...
    # --- Murkrow ---
    (198, "니로우", "Murkrow", "🌙", "rare", 0.50, None, None, "none"),

    # --- Slowking (trade evo from Slowpoke 79) ---
    (199, "야도킹", "Slowking", "🔮", "rare", 0.50, 79, None, "none"),

    # --- Misdreavus ---
    (200, "무우마", "Misdreavus", "👻", "rare", 0.50, None, None, "none"),
    ...
    # --- Gligar ---
    (207, "글라이거", "Gligar", "🦂", "rare", 0.50, None, None, "none"),
    ...
    # --- Sneasel ---
    (215, "포푸니", "Sneasel", "🌙", "rare", 0.50, None, None, "none"),
    ...
    (233, "폴리곤2", "Porygon2", "💻", "epic", 0.15, 137, None, "none"),
