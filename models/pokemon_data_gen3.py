...
ALL_POKEMON_GEN3 = [
    ...
    (299, "코코파스", "Nosepass", "🗿", "common", 0.80, None, 476, "friendship"),  # Nosepass
    ...
    (315, "로젤리아", "Roselia", "🌿", "rare", 0.50, None, 407, "friendship"),  # Roselia
    ...
    (356, "미라몽", "Dusclops", "👻", "rare", 0.50, 355, 477, "friendship"),  # Dusclops
