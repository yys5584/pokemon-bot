...
안녕하세요, 문박사입니다. 오늘 꽤 큰 업데이트가 있어서 직접 설명드립니다.

<b>🏕️ 캠프 시스템 리뉴얼</b>
TG포켓에는 배틀을 즐기는 허슬러와 수집을 즐기는 일반 유저가 있습니다. 캠프는 원래 일반 유저분들도 포켓몬을 활용할 수 있게 만든 시스템인데, 솔직히 너무 어려웠습니다. 그래서 전면 리뉴얼했습니다. 거점캠프를 정하고, 포켓몬을 배치하면 매일 자동 정산. DM에서 <b>'캠프'</b> 한 마디면 끝입니다.
...
<b>🎰 BP 뽑기 (신규!)</b>
BP 인플레이션이 심각했습니다. 쌓이기만 하고 쓸 곳이 없었어요. 그래서 만들었습니다 — <b>BP 가챠</b>. 100 BP로 피카츄 점술사의 구슬을 돌려보세요. 구슬이 잔잔하면 평범한 결과, <b>구슬이 미친듯이 빛나면... 대박입니다.</b> (뒤에 어떤 포켓몬이 보이는지도 잘 살펴보세요 👀) DM에서 <b>'뽑기'</b>를 입력하세요!
...
<b>💰 포획 BP 보상 (신규!)</b>
배틀 안 하는 분도 BP를 모을 수 있게, 이제 포켓몬을 잡으면 <b>20~50 BP</b>를 자동으로 받습니다. 잡고 → 모으고 → 뽑기 돌리고 → 강화하고... 이 순환을 만들고 싶었습니다.

<b>⚔️ 랭크전 개선</b>
"랭크전 해도 BP가 똑같으면 왜 하지?" — 맞는 말이었습니다. 도전자 BP <b>2배</b>, 동일 상대 RP 최소 보장.
...
이번 패치의 핵심은 <b>"할 게 생겼다"</b>입니다. 재미있게 즐겨주세요!
— 문박사 드림 🧑‍🔬"""
