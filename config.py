...
WEEKLY_RULES = {
    ...
    "cost_8": {
        "name": "코스트 8 이하",
        "icon": "💰",
        "desc": "팀 총 코스트 8 이하 (레어/커먼 위주)",
        "error": "이번 시즌은 팀 코스트 8 이하만 가능합니다!",
        "cost_limit": 8,
    },
    "cost_12": {
        "name": "코스트 12 이하",
        "icon": "💰",
        "desc": "팀 총 코스트 12 이하 (에픽 2~3 + 레어)",
    ...
    "cost_14": {
        "name": "코스트 14 이하",
        "icon": "💰",
        "desc": "팀 총 코스트 14 이하 (에픽 중심, 초전설 불가)",
    ...
    "cost_22": {
        "name": "코스트 22 이하",
        "icon": "💰",
        "desc": "팀 총 코스트 22 이하 (전설/초전설 다수 편성 가능)",
        "error": "이번 시즌은 팀 코스트 22 이하만 가능합니다!",
        "cost_limit": 22,
    },
    # --- 에픽 제한 (코스트 밸런스) ---
    "epic_max_2": {
