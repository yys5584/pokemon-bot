...
MEGA_EVOLUTION_POOL = {
    ...
    "rare": [
        (94, "메가팬텀"), (65, "메가후딘"), (208, "메가강철톤"), (127, "메가쁘사이저"),
    ],
    "epic": [
        (6, "메가리자몽"), (9, "메가거북왕"), (3, "메가이상해꽃"),
        (212, "메가핫삼"), (214, "메가헤라크로스"), (130, "메가갸라도스"),
        (359, "메가앱솔"), (373, "메가보만다"), (376, "메가메타그로스"),
        (445, "메가한카리아스"), (448, "메가루카리오"), (303, "메가입치트"),
        (306, "메가대짱이"),
    ],
    "legendary": [
        (380, "메가라티아스"), (381, "메가라티오스"),
    ],
    "ultra_legendary": [
        (150, "메가뮤츠X"), (150, "메가뮤츠Y"), (384, "메가레쿠쟈"),
    ],
}
