...
# (확률, 아이템키, 표시명, 이모지)
GACHA_TABLE = [
    (0.545, "bp_refund",     "BP 환급",          "💰"),
    (0.34,  "hyperball",     "하이퍼볼 ×2",       "🔵"),
    (0.0375,"masterball",    "마스터볼 ×1",       "🟣"),
    (0.03,  "iv_reroll_all", "개체값 재설정권 ×1", "🔄"),
    (0.02,  "bp_jackpot",    "BP 잭팟 +300",      "💎"),
    (0.0125,"iv_reroll_one", "IV 선택 리롤 ×1",   "🎯"),
    (0.0075,"shiny_egg",     "이로치 알 ×1",      "🥚"),
