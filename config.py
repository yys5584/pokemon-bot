...
EVENT_CATCH_LIMIT: int = 5         # 이벤트 채팅방 포획 인원
EVENT_STARTER_MASTERBALLS: int = 2 # 이벤트 참가 시 마스터볼 지급
...
PERSONALITY_TYPES = {
    "atk": {
        "name_ko": {"T1": "소심", "T2": "난폭", "T3": "사나움", "T4": "무쌍"},
        "bonus": {"atk": 1.0, "spa": 1.0},  # 공격/특공 보너스
    },
    "def": {
        "name_ko": {"T1": "유리몸", "T2": "단단", "T3": "억센", "T4": "철벽"},
        "bonus": {"hp": 0.5, "def": 1.0, "spdef": 0.5},  # 방어/특방 + HP 약간
    },
    "spd": {
        "name_ko": {"T1": "굼뜸", "T2": "재빠름", "T3": "질풍", "T4": "신속"},
        "bonus": {"spd": 1.2, "atk": 0.4, "spa": 0.4},  # 스피드 + 공격계 부스탯
    },
    "balance": {
        "name_ko": {"T1": "변덕", "T2": "냉철", "T3": "명석", "T4": "완벽"},
        "bonus": {"hp": 0.3, "atk": 0.3, "def": 0.3, "spa": 0.3, "spdef": 0.3, "spd": 0.3},  # 전스탯 균등 (개별 약하게)
    },
}
...
CAMP_LEVEL_TABLE = [
    ...
    (3,  2, 12, 48,  96,    "🔥 모닥불"),
    (4,  3, 12, 54,  250,   "🎪 텐트촌"),
    (5,  3, 14, 60,  400,   "🏚️ 통나무집"),
    (6,  4, 14, 66,  550,   "🌱 작은 정원"),
    (7,  4, 16, 72,  700,   "🏡 울타리집"),
    (8,  5, 16, 78,  900,   "💧 물레방아"),
    (9,  5, 18, 84,  1100,  "🏘️ 작은 마을"),
    (10, 6, 18, 90,  1500,  "🏛️ 광장"),
]
CAMP_MAX_LEVEL = 10
...
# ── 라운드 스케줄 (KST) ──
CAMP_ROUND_HOURS = [12]  # 하루 1회 정오
CAMP_ROUND_INTERVAL = 86400  # 24시간 (초)
CAMP_MIN_HOLD_SECONDS = 3600  # 정산 인정 최소 유지 시간 (1시간)
# 시간 비례 보상 구간 (유지시간 하한(초), 배율)
# 18h+ → 100%, 12~18h → 75%, 6~12h → 50%, 1~6h → 25%
CAMP_HOLD_TIERS = [
    (18 * 3600, 1.0),
    (12 * 3600, 0.75),
    (6 * 3600,  0.5),
